...
let apiDataGet = async () => {
    let data = getProjectData(2851)       // Change Project_ID Integer Value only Ex:1131
        .then((data) => {
...
$('#dropEnquiry').on("submit", function () {
    ...
    var tracking_lead_id = $('#gclid_field').val();
    // var checkbox = $('#dropEnquiry_CheckBox').val();
    saveLead(name, email,country_code, number, tracking_lead_id, 'top_enquire_form');
    return !1
})
$('#ModalForm').on("submit", function () {
    ...
    saveLead(name, email, country_code, number, tracking_lead_id, id + '_overview_homepage');
    return !1
})
$('#PopUpForm').on("submit", function () {
    ...
    var tracking_lead_id = $('#gclid_field').val();
    saveLead(name, email, country_code, number, tracking_lead_id,'PopUp_form_overview_homepage');
    return !1
})
...
async function saveLead(name, email, country_code,  number, tracking_lead_id, pref) {
    ...
    obj.number = number;
    obj.tracking_lead_id = tracking_lead_id;
