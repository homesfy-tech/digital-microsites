...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function modalFromOpen(event, title = "GOT QUESTIONS?") {
        ...
        document.body.style.overflow = "hidden";
        setTimeout(() => {
            modalFromCloseBtn.style.display = "block";
            modalFromOverlay.addEventListener("click", modalFromOverlayClick);
        }, 4000);
    }
    ...
    function modalFromClose() {
        ...
        modalFromCloseBtn.style.display = "none";
        modalFromOverlay.removeEventListener("click", modalFromOverlayClick);
    }
    ...
    function modalFromOverlayClick(e) {
    ...
    setTimeout(() => {
        modalFromOpen(null, "LIMITED TIME DEAL!");
    }, 4000);
