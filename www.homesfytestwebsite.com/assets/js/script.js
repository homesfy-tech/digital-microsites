...
burgerMenu.addEventListener("click", function (t) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        // Add js-enabled class to animated sections
        document.querySelectorAll(".amenitiesSection, .gallerySection, .priceSection, .floorPlanSection").forEach(function(section) {
...
document.querySelectorAll(".readMoreLink").forEach((t, e) => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        i.forEach((i) => {
            ...
            setTimeout(() => {
                (e.innerHTML = "Get Luxury Walkthrough"), (t.style.display = "flex");
            }, 4e3);
    });
class GalleryCarousel {
    constructor() {
