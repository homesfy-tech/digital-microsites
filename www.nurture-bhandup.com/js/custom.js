...
let apiDataGet = async () => {
    getProjectData(3853)       // Change Project_ID Integer Value only Ex:1131
        .then((data) => {
...
//             return true;
//         } 984329987654321a4329434234else if ((("0123456789").indexOf(keychar1) > -1)) {
//             return true;
//         } else {
//             return false;
//         }
...
$("#dropbtn").click(function () {
 ...
 async function saveLead(name, email, country_code, number, tracking_lead_id, pref) {
    ...
    if (country_code === '+91') {
        ...
        if (cleanNumber.length !== 10 || /^[0-5]/.test(cleanNumber)) {
